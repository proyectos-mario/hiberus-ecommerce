CREATE USER ecommercelogistic;
ALTER USER ecommercelogistic WITH PASSWORD 'ecommercelogistic';
CREATE DATABASE ecommercelogisticbd WITH OWNER = ecommercelogistic ;
